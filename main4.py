...
def HAD(args):
    ...
    plt.axis('off')
    plt.margins(0, 0)
    plt.savefig("Result/AB2.png", bbox_inches='tight', pad_inches=0.0)
    plt.show()

if __name__ == '__main__':

    parser = argparse.ArgumentParser()
    parser.add_argument('--data_dir', type=str, default="./Data/AB2_split.mat")
    # parser.add_argument('--data_dir', type=str, default="./Data/abu-beach-2.mat")
    # parser.add_argument('--data_dir', type=str, default="./Data/HAD100_33.mat")
