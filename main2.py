...
def HAD(args):
    ...
    AE.load_state_dict(torch.load("AE_0050.pth", map_location=lambda storage, loc: storage))
    ...
    plt.axis('off')
    plt.margins(0, 0)
    plt.savefig("Result/AU5.png", bbox_inches='tight', pad_inches=0.0)
    plt.show()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default="./Data/AU5_split.mat")
    # parser.add_argument('--data_dir', type=str, default="./Data/abu-urban-5.mat")
