...
def HAD(args):
    ...
    plt.axis('off')
    plt.margins(0, 0)
    plt.savefig("Result/AA3.png", bbox_inches='tight', pad_inches=0.0)
    plt.show()

if __name__ == '__main__':

    parser = argparse.ArgumentParser()
    parser.add_argument('--data_dir', type=str, default="./Data/AA3_split.mat")
    # parser.add_argument('--data_dir', type=str, default="./Data/abu-airport-3.mat")
