...
def HAD(args):
    ...
    # AE.load_state_dict(torch.load("AE_0122.pth", map_location=lambda storage, loc: storage))
    ...
    plt.axis('off')
    plt.margins(0, 0)
    plt.savefig("Result/AB3.png", bbox_inches='tight', pad_inches=0.0)
    plt.show()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default="./Data/AB3_split.mat")
    # parser.add_argument('--data_dir', type=str, default="./Data/abu-beach-3.mat")
    # parser.add_argument('--data_dir', type=str, default="./Data/HAD100_24.mat")
