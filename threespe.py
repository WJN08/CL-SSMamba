...
class Encoder(nn.Module):
    def __init__(self, input_dim, latent_layer_dim):
        ...
        self.conv1 = nn.Conv2d(in_channels=188, out_channels=94, kernel_size=(64, 1), stride=(3, 1),
                               padding=0)  # 高度变 361 → 100，宽度不变
        self.conv2 = nn.Conv2d(in_channels=94, out_channels=94, kernel_size=1)  # 通道数降 188 → 94
    ...
    def forward(self, x): #100 100 188
        ...
        e11 = self.act_f_1(self.conv2(self.conv1(x)))
        e11 = e11.reshape(e11.shape[1], e11.shape[2], e11.shape[0])
        ...
        # x_spa = x_spa.reshape(x_spa.shape[0], x_spa.shape[2], x_spa.shape[3], x_spa.shape[1])
        # e11 = self.m1(x_spa)
        print("e11", e11.shape)
...
class OrthoAE_Unet(nn.Module):
    ...
    def forward(self, x, args):
        ...
        return attention_fea, dec_normalized, dec, dec1, dec1
